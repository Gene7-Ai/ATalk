<p align="center">
  <picture>
    ...
    <img src="docs/brand/atalk-lockup-light.png" width="560" alt="ATalk — Agent collaboration">
  </picture>
</p>
...
**Status: early-stage / pre-release (0.3.0a4).** The server, protocol, adapters and
